...
/* =========================================================
   CSS
========================================================= */
/* Replace ONLY the contents of `const baseCss = \` ... \`;` with this whole block.
   Keep: `const baseCss = \`` at the top and the closing backtick + semicolon at the end.
*/
...
:root{
  ...
  --shadow2: 0 22px 60px rgba(0,0,0,.50);
  ...
  /* HEX geometry (tunes 7676767) */
  --hexWMain: 92px;
  --hexHMain: 80px;
  --hexStepX: 72px; /* overlap spacing */
  --hexFieldH: calc(var(--hexHMain) * 7); /* 7 rows tall */
}
...
/* =========================================================
   HEX SLOTS + HEX BUTTON (FIXED: removed invalid nested .hex)
========================================================= */
.hexSlot{
  width: var(--hexWMain);
  height: var(--hexHMain);
...
/* =========================================================
   DECK CARDS (GUTTERS + TWINKLE BORDER)
========================================================= */
.hexDeckOverlay{
  position: absolute;
  inset: 0;
...
.hexDeckCard::after{
  ...
  animation: inherit, twinkle 1.3s ease-in-out infinite;
}
