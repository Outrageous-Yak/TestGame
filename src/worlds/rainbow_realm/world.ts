  ...
  scenarios: [
    {
      ...
      tracks: [
        ...
        { id: "t10", name: "Track 10 — Northwest Maze", scenarioJson: "worlds/rainbow_realm/scenarios/prism_path/scenario9.json" },
        { id: "t11", name: "Track 11 — Southwest Spire", scenarioJson: "worlds/rainbow_realm/scenarios/prism_path/scenario10.json" },
